...
public class MutableImage {
    ...
    private void rotate(int exifOrientation) throws ImageMutationFailedException {
        ...
        switch (exifOrientation) {
            case 1: // TODO Find a way to remove the postRotate for 'case 1' and still have it working for Samsung phones w/o the 90 degree rotation in the saved image.
                bitmapMatrix.postRotate(90); // This line was originally empty in 'react-native-camera's MutableImage.java. The reason it's here now is possibly due to my test device being a Samsung Galaxy S6 Edge.
                break;
            case 2:
                break;
            case 3:
